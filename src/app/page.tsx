...
import { ArrowRight, MessageCircle, Check, GraduationCap, Briefcase, Plane, Rocket, ShieldCheck, MapPin, Award } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto mb-12 leading-relaxed">
              20 años asesorando agencias, certificando profesionales y operando viajes. 
      ...
      <section className="py-20 bg-slate-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <StatCard number="20" label="Años de Experiencia" />
            <StatCard number="500+" label="Agentes Certificados" />
            <StatCard number="50+" label="Agencias Asesoradas" />
            <StatCard number="+15M" label="M USD en Ventas" />
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-white/5 py-12 bg-slate-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-center md:text-right">
            ...
            <p className="text-xs text-slate-600">Montevideo, Uruguay • Desde 2006</p>
          </div>
        </div>
      </footer>
...
function StatCard({ number, label }: { number: string, label: string }) {
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 text-center hover:bg-white/10 transition-colors">
      <div className="text-3xl md:text-4xl font-black text-gradient mb-2">{number}</div>
